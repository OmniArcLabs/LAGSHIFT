# LAGSHIFT 1.0 Release Checklist
...
- [x] Unit and security-adversarial suite passes: 132 tests.
...
- [x] Update, remote catalog, and backend-dependent paths fail closed.
...
Version 1.0.0 is a local-first Stable release with the limitations above. Do not
