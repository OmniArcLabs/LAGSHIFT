...
- تشخیص محافظه‌کار «تعرفهٔ داخلی» برای لینک سایت یا فایل: دنبال‌کردن Redirect،
  بررسی میزبان نهایی و IPv4/IPv6، تشخیص اختیاری اپراتور، استعلام کمکی و فقط-میزبان
  LinkIrani، هشدار WARP/VPN و رسید پاک‌سازی‌شده برای پیگیری ۱۹۵
...
استعلام ثالث فرستاده نمی‌شود. ثبت دامنه یا IP در فهرست تعرفهٔ داخلی، ضریب نهایی
کسر بسته توسط اپراتور را تضمین نمی‌کند.
